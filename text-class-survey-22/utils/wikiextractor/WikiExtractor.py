...
from utils.wikiextractor.extract import Extractor, ignoreTag, define_template, acceptedNamespaces
...
def process_dump(input_file, template_file, out_file, file_size, file_compress,
    ...
    # - a reduce __process collects the results, sort them and print them.
    ...
    for _ in range(max(1, process_count)):
        ...
        extractor.daemon = True  # only live while parent __process lives
        extractor.start()
    ...
    # signal end of work to reduce __process
    ...
    logging.info("Finished %d-__process extraction of %d articles in %.1fs (%.1f art/s)",

...
TRAIN_FILE=src/models/HBGL/data_ours/bgc/bgc_train_generated_tl.json
...
if [ ! -f $TRAIN_FILE ]; then
  python src/models/HBGL/preprocess.py bgc
fi
...
python src/models/HBGL/run.py\
    ...
    --wandb \
    --taxonomy_file data/BGC/bgc_tax.txt
#    --only_test --only_test_path src/models/HBGL/models/bgc/ckpt-94500 --taxonomy_file data/BGC/bgc_tax.txt

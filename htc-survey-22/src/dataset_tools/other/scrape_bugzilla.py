...
CODE FROM: https://github.com/Forethought-Technologies/ieee-dsmp-2018-paper/blob/master/scrape_bugzilla.py
...
def scrape_bugzilla():
    ...
    all_results = []
    for bug_idx in tqdm.tqdm(range(1, 16561)):  # Magic number of bugs in the tracker
        if bug_idx % 100 == 0:
